...
public class Update extends SalesForceSoapAPI {
     ...
     * @throws Exception 
     */
	public Update(String role, String xmlFileName) throws Exception {
    ...
    public void setSObjectNodeByNameAndValue(String nodeName, String value) throws Exception {
        setRequestNodeValueByXPath("/Envelope/Body/update/sObjects/" + nodeName, value);
    }
    ...
    public String getID() throws Exception {
        return getResponseNodeValueByXPath("/Envelope/Body/updateResponse/result/id");
    ...
    public String getSuccess() throws Exception {
        return getResponseNodeValueByXPath("/Envelope/Body/updateResponse/result/success");
    }
    ...
    public String getErrorMessage() throws Exception {
        return getResponseNodeValueByXPath("/Envelope/Body/updateResponse/result/errors/message");
    }
}